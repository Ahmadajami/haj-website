...
>
    ...
    >
        <AnimatedShinyText class="inline-flex items-center justify-center">
            <span>✨ Introducing HAJ Agency</span>
            {" "}
            <ArrowRightIcon
    ...
    >
        <span class="text-[var(--color-one)]">HAJ Agency</span>
    ...
    >
        Unlock the full potential of your ideas with our integrated services in
        <br class="hidden md:block" />
        {" "}
        Web Development,
        <a href="https://svelte.dev" class="underline underline-offset-2">HR</a
        >, and
        <a
            href="https://animation-svelte.vercel.app"
            class="underline underline-offset-2">UI/UX</a
        > and Interior Design.
    </p>
    <Button
