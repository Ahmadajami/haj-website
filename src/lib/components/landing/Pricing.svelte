...
<section id="pricing">
    <div
        class="mx-auto flex max-w-screen-xl flex-col gap-8 px-4 py-14 my-8 md:px-8"
    >
        <div class="mx-auto max-w-5xl text-center">
            ...
            <h2
                class="text-5xl font-bold tracking-tight text-black dark:text-white sm:text-6xl"
            >
        ...
        <div
            class="mx-auto grid w-full flex-col justify-center gap-4 sm:grid-cols-2 lg:grid-cols-4"
        >
                ...
                >
                    <div class="flex items-center">
                        <div class="ml-4">
                            ...
                            <p
                                class="h-12 text-sm leading-5 text-black/70 dark:text-white"
                            >
                                {price.description}
                            </p>
                        </div>
